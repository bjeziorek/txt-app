...
// app.get('/data/pl', (req: any, res:any):void => {
...
// app.get('/data/en', (req: any, res:any):void => {
//   fs.readFile("./data/langs/en.properties", 'utf8', (err: NodeJS.ErrnoException | null, data: string) => {
//     if (err) {
//       return res.status(500).send('Error reading file');
//     }
//   //  jsonData = JSON.parse(data);
...
// app.post('/data/testSave', (req:any, res:any) => {
//   saveJson(req,res);
// });
